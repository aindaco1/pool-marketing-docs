...
- [`_layouts/default.html`](../_layouts/default.html): shared public layout
- [`_layouts/campaign.html`](../_layouts/campaign.html): campaign detail layout
- [`_includes/cart-runtime-foot.html`](../_includes/cart-runtime-foot.html): lightweight cart loader include
...
The runtime lives at [`assets/js/page-prefetch.js`](../assets/js/page-prefetch.js). It is loaded on public page surfaces by default and stays out of private app layouts.

### Configuration

The shared include is [`_includes/page-prefetch.html`](../_includes/page-prefetch.html). It emits the runtime only when this config is enabled:
