...
Estos términos reflejan el hito del lanzamiento de la plataforma The Pool **v1.0.5**.
...
- Los administradores de la plataforma pueden usar el panel para administrar la configuración de la campaña, la configuración de la plataforma, los complementos, los enlaces de referencia y los usuarios autorizados del panel. Los valores secretos se guardan en almacenes secretos de implementación o en archivos locales ignorados, no en el contenido de la campaña ni en los borradores del panel.
