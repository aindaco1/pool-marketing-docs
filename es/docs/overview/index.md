...
Vaya a [Desarrollo](/es/docs/development/) una vez que necesite el flujo de trabajo del colaborador, la estructura del código o los detalles de personalización. Vaya a [Operaciones](/es/docs/operations/) cuando esté configurando el trabajador, probando flujos o validando la preparación para la versión.
