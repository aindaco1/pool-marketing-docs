...
2. [Contribuyendo con ](/es/docs/development/contributing/) para conocer los requisitos previos, la configuración local, el flujo de trabajo de GitHub y el estado actual del proyecto.
